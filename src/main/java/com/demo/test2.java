...
public class test2 {
    ...
    public static void testZh() throws Exception {
        File imageFile = new File("E:/IdeaSpace/Tess4j_demo/src/main/resources/pictures/16.png");
        ...
        //字库路径
        instance.setDatapath("E:\\IdeaSpace\\Tess4j_demo\\src\\main\\resources\\tessdata");
