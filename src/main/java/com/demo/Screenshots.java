...
public class Screenshots {
    ...
    public static void main(String[] args) {
        ...
        //图片必须是32-bit color
        screenshots.srcpath = "E:\\IdeaSpace\\Tess4j_demo\\src\\main\\resources\\pictures\\6.png";
        screenshots.subpath = "E:\\IdeaSpace\\Tess4j_demo\\src\\main\\resources\\pictures\\6-shot.png";
        try {
            screenshots.cut();
        } catch (IOException e) {
            e.printStackTrace();
